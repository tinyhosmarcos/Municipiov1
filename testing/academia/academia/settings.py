...
SECRET_KEY = 'er+of81-lq96767x_jf$8u$t@h=g_0etfvm1z_lyd$+u!0=a_a'
...
STATIC_URL = '/static/'
LOGIN_REDIRECT_URL = reverse_lazy('asistencia:index')
LOGOUT_REDIRECT_URL=reverse_lazy('register:login')